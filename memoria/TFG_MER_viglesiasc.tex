...
En este capítulo se describe el proceso del desarrollo de la aplicación de MER. Primeramente, se describe el conjunto de datos utilizado en el experimento, y cómo los datos han sido manipulados para ser utilizados por el sistema. Por último, se describen las técnicas de \textit{Machine Learning} utilizadas en la aplicación.
